...
1. Load the `netflix_titles.csv` dataset into your SQL environment.
2. Use the queries from `Solution.sql` to run the analysis.
3. Modify parameters like years, names, or keywords to customize results.

---

##  Learnings

- Data cleaning with `SPLIT_PART`, `UNNEST`, and `ILIKE`
- Ranking and partitioning with `RANK() OVER (PARTITION BY …)`
...
- [LinkedIn](www.linkedin.com/in/praveens2912)
- [GitHub Portfolio](https://github.com/Praveens2912) 
